...
function App() {
  ...
  // company name (slightly emphasized)
  doc.setFont("times", "bold");
  doc.setFontSize(9.5);
  doc.setTextColor(30, 30, 30);
  doc.text("RDN CREATORS", 105, footerY + 6, { align: "center" });

  // address & contact (lighter)
  doc.setFont("times", "normal");
  doc.setFontSize(8.5);
  doc.setTextColor(40, 40,40);
  doc.text(
    "111/4, Gobinathapuram, Vellapillayar Kovil, Vattakadu (PO), Omalur (TK), Salem – 636012\n" +
      "Phone: 95133 33935  |  Email: rdncreators@gmail.com  |  GSTIN: 33AAXFR1418G2Z2",
    105,
    footerY + 12,
    { align: "center" }
  );
...
const pageHeight = doc.internal.pageSize.height;
const footerHeight = 30; // must match footer space

let totalsY = doc.lastAutoTable.finalY + 12;

// If totals are too close to footer, push them up
const maxTotalsY = pageHeight - footerHeight - 25;

if (totalsY > maxTotalsY) {
  totalsY = maxTotalsY;
}

// Totals (same size & style)
doc.setFont("times", "bold");
doc.setFontSize(12);
